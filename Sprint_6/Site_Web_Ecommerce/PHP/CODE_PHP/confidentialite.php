...
<body>
    ...
    <div class="infosContainer">
        ...
        <h2 class="infosTitle">Politique de confidentialité pour le site web d'Art'i'Chaude</h2>
        
        <hr>

        <p>La société Art'i'Chaude (dont le siège social est situé à Bordeaux), en sa qualité de responsable du traitement, attache une grande importance à la protection et au respect de votre vie privée. <br/>
        ...
        <p>En utilisant le site d'Art'i'Chaude, vous êtes amenés à nous transmettre des informations, dont certaines sont de nature à vous identifier et constituent de ce fait des données à caractère personnel (ci-après dénommées les « données »).</p>
        ...
        <p id="test">Nous utilisons les données que nous recueillons afin de : </p>
        ...
        <p>Lors de la collecte des données, vous serez informé si certaines données doivent être obligatoirement renseignées ou si elles sont facultatives. <br/>
        ...
        <h2>3 - Qui sont les destinataires des données que nous collectons et pour quelles raisons leur transmettons-nous ces données ?</h2>

        <h3>3.1 - Données traitées par Art'i'Chaude</h3>

        <p>Les données collectées nous sont destinées en notre qualité de responsable du traitement :</p>
        ...
        <p>Lorsque les durées de conservation arrivent à leur terme, vos sonnées sont effacées ou anonymisées de manière à pouvoir les exploiter sans porter atteinte à vos droits. <br/> 
        ...
        <p>Nous prenons des mesures adéquates sur le plan de la technique et de l’organisation pour interdire l’accès non autorisé ou la modification, divulgation, perte ou destruction de vos données.</p>
        ...
        <p>Conformément aux lois et règlements applicables en matière de protection des données personnelles, vous bénéficiez d’un certain nombre de droits relatifs à vos données, à savoir :</p>
        ...
        <p>Notez que nous pouvons exiger un justificatif de votre identité pour l’exercice de ces droits.</p>

        <h2>8 - Modification de notre politique de confidentialité</h2>

        <p>Nous pouvons être amenés à modifier occasionnellement la présente politique, afin notamment de se conformer à toutes évolutions réglementaires, jurisprudentielles, éditoriales ou techniques. <br/>
