...
<body>
    ...
    <div class="infosContainer">
        ...
        <h2 class="infosTitle">Politique de cookies pour Art'i'Chaude</h2>

        <hr>

        <h1>Politique de cookies</h1>

        <p>Cette politique de cookies explique ce que sont les cookies et comment nous les utilisons. 
        ...
        <h1>L'utilisation des cookies</h1>

        <h2>Type de cookies utilisés :</h2>

        <p>Les cookies peuvent être des cookies "persistants" ou des cookies "de session". 
        ...
        <p>Si vous préférez éviter l'utilisation de cookies sur le site web, vous devez d'abord désactiver l'utilisation de cookies dans votre navigateur, puis supprimer les cookies enregistrés dans votre navigateur associé à ce site web.
