...
==== *Documentation WEB* : 
    - Charte graphique : https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-10/tree/master/Sprint_3/Site_Web_Ecommerce/PHP/DOC_PHPCharteGraphique.pdf[Charte graphique]
