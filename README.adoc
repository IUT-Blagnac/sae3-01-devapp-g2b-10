...
| *Documentation partie communication* :
|    - https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-10/blob/master/Sprint_6/Documentation%20hebdomadaire-Communication/ODJ_-_Post_Mortem.pdf[Ordre du jour]
|===
