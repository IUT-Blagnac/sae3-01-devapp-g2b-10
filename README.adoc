...
- Documentation BD :  https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-10/tree/master/DOC_BD/Rapport_BD.pdf[Rapport BD]

- Documentation IOT : PAS FINI :  https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-10/tree/master/DOC_IOT[Rapport_IOT]
